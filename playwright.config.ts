...
export default defineConfig({
  ...
  projects: [
    { name: 'preview', testIgnore: '**/registration-api.spec.ts', use: { baseURL: 'http://127.0.0.1:5183' } },
    { name: 'registration-api', testMatch: '**/registration-api.spec.ts', use: { baseURL: 'http://127.0.0.1:5184' } },
  ],
  webServer: [
