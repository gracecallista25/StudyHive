...
export const students: Student[] = [
  {
    id: 'lin', name: 'Lin Chen', major: 'Computer Science', entryYear: 2022,
    course: 'Operating Systems', availabilityLabel: 'Mon, Wed, Fri evenings',
    availability: ['evenings'], freeTonight: true, studyStyle: 'discussion',
    studyStyleLabel: 'Focus together, discuss problems',
  ...
  {
    id: 'maya', name: 'Maya Tan', major: 'Electronic Information', entryYear: 2023,
    course: 'Signal and Systems', availabilityLabel: 'Tue, Thu evenings, weekends',
    availability: ['evenings', 'weekends'], freeTonight: false, studyStyle: 'quiet',
    studyStyleLabel: 'Mix of discussion and individual focus',
  ...
  {
    id: 'alex', name: 'Alex Wu', major: 'Mechanical Engineering', entryYear: 2021,
    course: 'Mechanics', availabilityLabel: 'Weekday evenings, Sat afternoon',
    availability: ['evenings', 'afternoons', 'weekends'], freeTonight: true, studyStyle: 'practice',
    studyStyleLabel: 'Solve problems together',
  ...
  {
    id: 'yuna', name: 'Yuna Li', major: 'Materials Science', entryYear: 2024,
    course: 'Materials Chemistry', availabilityLabel: 'Mon, Tue, Thu evenings',
    availability: ['evenings'], freeTonight: false, studyStyle: 'discussion',
    studyStyleLabel: 'Discussion first, then practice',
